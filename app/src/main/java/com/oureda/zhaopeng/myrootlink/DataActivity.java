        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.id_ll_tabLayout2:
                    startActivity(new Intent(DataActivity.this, MessageActivity.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    finish();
                    break;
                ...
                case R.id.id_ll_tabLayout4:
                    startActivity(new Intent(DataActivity.this, ProductActivity.class));
                    overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
                ...
                case R.id.id_menu_sensor:
                    startActivity(new Intent(DataActivity.this, SensorActivity.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                ...
                case R.id.id_menu_wexin:
                    startActivity(new Intent(DataActivity.this, WexinActivity.class));
                    overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
                ...
                case R.id.id_menu_logout:
                    startActivity(new Intent(DataActivity.this, LogoutActivity.class));
