...
public class WexinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://www.rootlink.cn/dashboard/wx");
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url != null && url.contains("rootlink.cn")) {
                    ...
                    startActivity(new Intent(WexinActivity.this, HomeActivity.class));
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.id_ll_tabLayout2:
                    startActivity(new Intent(WexinActivity.this, MessageActivity.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    finish();
                    break;
                case R.id.id_ll_tabLayout3:
                    startActivity(new Intent(WexinActivity.this, FileActivity.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);

                    finish();
                    break;
                case R.id.id_ll_tabLayout4:
                    startActivity(new Intent(WexinActivity.this, ProductActivity.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                ...
                case R.id.id_menu_sensor:
                    startActivity(new Intent(WexinActivity.this, SensorActivity.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                ...
                case R.id.id_menu_data:
                    startActivity(new Intent(WexinActivity.this, DataActivity.class));
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                    mCameraDialog.dismiss();
                ...
                case R.id.id_menu_logout:
                    startActivity(new Intent(WexinActivity.this, LogoutActivity.class));
                    mCameraDialog.dismiss();
                    //注销登陆，待补充
                    break;
